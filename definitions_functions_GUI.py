...
file_path = "data_test_KOPIE.txt"         # Benamung der Datei für die Daten
file_path_new = "data_test.txt"
...
def check_for_character(input_file, target_character):       # Funktion Überprüfung von spezifischen Charakter
    with open(input_file, "r") as file:                # öffne Speicherdatei 
